...
import { scheduledMaintenanceRouter }     from './scheduled-maintenance';
import { rentReconciliationRouter }        from './rent-reconciliation';
import { documentExpiryRouter }             from './document-expiry';
...
propertiesRouter.use('/scheduled-maintenance', scheduledMaintenanceRouter);
propertiesRouter.use('/rent-reconciliation', rentReconciliationRouter);
propertiesRouter.use('/document-expiry',     documentExpiryRouter);
